...
public class MainActivity extends AppCompatActivity {
    ...
    public static String x= "MainActivity";
...
//                .url("http://api.geonames.org/countryInfoJSON?formatted=true&lang=it&username=sangdeptrai&style=full&fbclid=IwAR08fl7oYFYtzl0c7sdL9i6x72TIgMBHo-7cmOwgGNwKzVRwojXqYCl1O6A")
                .build();
